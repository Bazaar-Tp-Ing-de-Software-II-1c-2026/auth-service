...
@router.patch("/{notification_id}/mark-as-read", response_model=schemas.NotificationResponse)
def mark_notification_as_read(
    ...
    if not notification:
        logger.warning(f"Notificación no encontrada: notification_id={notification_id}, user_id={current_user.id}")
        raise HTTPException(
    ...
    logger.info(f"Notificación marcada como leída: notification_id={notification_id}, user_id={current_user.id}")
...
def delete_notification(
    ...
    logger.info(f"Notificación eliminada: notification_id={notification_id}, user_id={current_user.id}")
